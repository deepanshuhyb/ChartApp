...
export default function StockChart () {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-900'>
      <div className='relative flex flex-col items-center bg-gray-950 p-6 rounded-lg shadow-xl w-full max-w-7xl mx-auto'>
        ...
        <div className='flex flex-wrap gap-2 mt-4'>
          {timeframes.map(tf => (
            <button
              ...
              onClick={() => setTimeframe({ label: tf.label, days: tf.days })}
            >
              {tf.name}
            </button>
          ))}
